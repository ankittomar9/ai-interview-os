---
slug: dsa-replace-a-substring-in-a-string
title: Replace a substring in a string.
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_84_Reverse_Words.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: hello
...
editorial: '### Replace a substring in a string.
