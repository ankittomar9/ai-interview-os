---
slug: dsa-reverse-a-number-using-recursion
title: Reverse a number using recursion.
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_109_Reverse_a_number_using_recursion.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: 12 18
...
editorial: '### Reverse a number using recursion.
