...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_83_Remove_Chars_From_Second_String.java
status: PUBLISHED
sampleTests:
- name: Sample 1
...
editorial: '### Check if two strings match where one string contains wildcard characters.
