---
slug: dsa-remove-vowels-from-a-string
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_72_Remove_Vowels.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: hello
...
editorial: '### Remove Vowels from a string.
