---
slug: dsa-find-the-first-non-repeating-character
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_90_String_To_Integer.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: hello
...
editorial: '### Find the first non-repeating character.
