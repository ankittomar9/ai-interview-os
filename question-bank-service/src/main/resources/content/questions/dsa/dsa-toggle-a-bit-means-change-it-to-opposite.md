---
slug: dsa-toggle-a-bit-means-change-it-to-opposite
title: Toggle A Bit Means Change It To Opposite
...
- junior
buildProfile: judge0
source: inspired-by:operator-corpus/Q_6_toggle_a_bit_means_change_it_to_opposite.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: 12 18
...
editorial: '### Toggle A Bit Means Change It To Opposite
