...
- junior
buildProfile: judge0
source: inspired-by:operator-corpus/Q_9_Interesting_array.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '5
    ...
    1 2 3 4 5'
  expectedOutput: "No given array is not interesting \n1 2 3 4 5"
  description: Primary test case
- name: Sample 2
  input: '4

    4 2 1 3'
  expectedOutput: 'Yes given array is interesting
