---
slug: dsa-remove-characters-from-a-string-except-alphabets
title: Remove characters from a string except alphabets.
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_75_Remove_Except_Alphabets.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: hello
...
editorial: '### Remove characters from a string except alphabets.
