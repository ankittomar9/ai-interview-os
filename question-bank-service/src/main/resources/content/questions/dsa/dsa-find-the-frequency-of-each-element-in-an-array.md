---
slug: dsa-find-the-frequency-of-each-element-in-an-array
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_35_Find_the_Frequency_of_each_element_in_an_array.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '5
    ...
    1 2 3 4 5'
  expectedOutput: '{1=1, 2=1, 3=1, 4=1, 5=1}
...
- name: Hidden 1
  input: '6
    ...
    -2 1 -3 4 -1 2'
  expectedOutput: '{-1=1, -2=1, 1=1, -3=1, 2=1, 4=1}
...
editorial: '### Find the Frequency of each element in an array.
