---
slug: dsa-find-max-element-in-array-using-recursion
title: Find max element in array using recursion.
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_110_Max_Element_Using_Recursion.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '5
...
editorial: '### Find max element in array using recursion.
