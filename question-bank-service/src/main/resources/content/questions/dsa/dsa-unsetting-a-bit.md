...
- junior
buildProfile: judge0
source: inspired-by:operator-corpus/Q_5_Unsetting_a_Bit.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: 12 18
  expectedOutput: 'Evaluating n : 12 and Position i : 18
    ...
    Number after modifying ith Bit : 12'
  description: Primary test case
- name: Sample 2
  input: 7 13
  expectedOutput: 'Evaluating n : 7 and Position i : 13

    Number after modifying ith Bit : 7'
...
- name: Hidden 1
  ...
  expectedOutput: 'Evaluating n : 10 and Position i : 25
    ...
    Number after modifying ith Bit : 10'
  weight: 25
- name: Hidden 2
  input: 3 4
  expectedOutput: 'Evaluating n : 3 and Position i : 4

    Number after modifying ith Bit : 3'
  weight: 25
- name: Hidden 3
  input: 15 5
  expectedOutput: 'Evaluating n : 15 and Position i : 5

    Number after modifying ith Bit : 15'
  weight: 50
hints:
