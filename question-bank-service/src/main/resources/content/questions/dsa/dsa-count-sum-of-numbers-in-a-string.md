---
slug: dsa-count-sum-of-numbers-in-a-string
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_78_Sum_Of_Numbers_In_String.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: hello
...
editorial: '### Count sum of numbers in a string.
