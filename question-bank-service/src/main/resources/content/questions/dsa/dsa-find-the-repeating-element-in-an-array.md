---
slug: dsa-find-the-repeating-element-in-an-array
title: Find the Repeating element in an array.
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_44_Find_the_repeating_element_array.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '5
...
editorial: '### Find the Repeating element in an array.
