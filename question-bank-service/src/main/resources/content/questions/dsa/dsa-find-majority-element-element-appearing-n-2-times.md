---
slug: dsa-find-majority-element-element-appearing-n-2-times
title: Find Majority Element (element appearing > N/2 times).
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_54_Majority_Element.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '5
...
editorial: '### Find Majority Element (element appearing > N/2 times).
