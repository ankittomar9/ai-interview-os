---
slug: dsa-remove-duplicate-elements-from-an-unsorted-array
title: Remove Duplicate elements from an unsorted array.
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_40_Remove_Duplicates_Unsorted.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '5
...
editorial: '### Remove Duplicate elements from an unsorted array.
