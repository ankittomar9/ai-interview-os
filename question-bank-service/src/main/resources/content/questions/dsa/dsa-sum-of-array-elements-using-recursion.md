---
slug: dsa-sum-of-array-elements-using-recursion
...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_112_Sum_of_array_elements_using_recursion.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '4 2
...
editorial: '### Sum of array elements using recursion.
