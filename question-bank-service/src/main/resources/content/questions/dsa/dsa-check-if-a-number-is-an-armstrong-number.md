---
slug: dsa-check-if-a-number-is-an-armstrong-number
...
- junior
buildProfile: judge0
source: inspired-by:operator-corpus/Q_3_ArmStrong_Number.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '5'
...
editorial: '### Check if a number is an Armstrong Number.
