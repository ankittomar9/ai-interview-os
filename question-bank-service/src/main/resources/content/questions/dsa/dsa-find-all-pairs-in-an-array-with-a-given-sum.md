...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_45_Find_All_Pairs_Sum.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '4 2
    ...
    2 7 11 15'
  expectedOutput: 'No pairs add up to the target sum.
...
editorial: '### Find all Pairs in an array with a given Sum.
