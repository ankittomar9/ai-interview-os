...
- mid
buildProfile: judge0
source: inspired-by:operator-corpus/Q_52_Replace_Each_Element_by_its_Rank_in_the_Array.java
status: PUBLISHED
sampleTests:
- name: Sample 1
  input: '5
...
editorial: '### Replace each element by its Rank in the array.
