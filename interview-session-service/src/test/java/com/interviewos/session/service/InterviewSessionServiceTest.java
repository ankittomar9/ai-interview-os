...
class InterviewSessionServiceTest {
    ...
    static Stream<Arguments> all28Combinations() {
        ...
        for (InterviewTrack track : InterviewTrack.values()) {
            if (track == InterviewTrack.FULL_LOOP || track == InterviewTrack.DSA_LLD || track == InterviewTrack.DSA_LLD_HLD || track == InterviewTrack.LLD_HLD || track == InterviewTrack.CUSTOM) continue; // 7 focused tracks x 4 difficulties = 28 combinations
