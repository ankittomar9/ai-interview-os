...
export type InterviewTrack = 'JAVA_SPRING_BOOT' | 'ALGORITHMS_DATA_STRUCTURES' | 'SYSTEM_DESIGN' | 'BEHAVIORAL_STAR' | 'SPRING_LLD' | 'SQL' | 'RESUME_BASED' | 'FULL_LOOP' | 'DSA_LLD' | 'DSA_LLD_HLD' | 'LLD_HLD';
