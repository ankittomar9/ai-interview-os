...
export const ProjectWorkspace: React.FC<Props> = ({
  ...
  return (
    <div className="flex-1 flex flex-col bg-bg overflow-hidden relative h-full">
      ...
      <div className="h-10 bg-surface border-b border-border flex items-center justify-between px-3 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <Chip variant="neutral" size="sm">{editablePaths.length} Editable Files</Chip>
        </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* 1. FILE TREE SIDEBAR */}
        <div className="w-64 bg-surface border-r border-border flex flex-col shrink-0 select-none">
        ...
        <div className="flex-1 flex flex-col bg-bg overflow-hidden">
          ...
          {!isEditable(activePath) && (
            <div className="bg-amber-500/10 border-b border-amber-500/30 px-3 py-1 flex items-center gap-2 text-xs text-amber-300">
              ...
              <span>Read-only reference file. Models, repositories, and build scripts are managed by the platform.</span>
            </div>
          )}
